...
if [ $ARCH = "x86_64" ]; then
SYSROOT_VER='1'
SYSROOT_SUM='393b61e418f44ae6fd5051bb3bf3ec964f29e39d8b4165ed743bab95042cbdf7'
SYSROOT_TAR="solaris-11.4.42.111.0-i386-sysroot-v$SYSROOT_VER.tar.gz"
SYSROOT_URL='http://192.168.15.2/rust/'
SYSROOT_URL+="$SYSROOT_TAR"
SYSROOT_DIR="$PREFIX/sysroot-x86_64"
else
SYSROOT_VER='1'
SYSROOT_SUM='6396224c59681394142a03be0a0bb2d2f0f282472930825969e63632e8896184'
SYSROOT_TAR="solaris-11.4.42.111.0-sparc-sysroot-v$SYSROOT_VER.tar.gz"
SYSROOT_URL='http://192.168.15.2/rust/'
SYSROOT_URL+="$SYSROOT_TAR"
SYSROOT_DIR="$PREFIX/sysroot-x86_64"
fi
